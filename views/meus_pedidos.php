...
<head>
    ...
    <script src="http://localhost/Trufarly.com.br/views/js/meus_pedidos.js" defer></script>
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="meuModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="meuModalLabel">Pedido Concuido</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <span>
                    Seu pedido foi concluido, consulte o status do seu pedido na area de meus pedidos.
                </span>
            </div>
